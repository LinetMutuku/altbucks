...
export default function FeaturedTaskCreator() {
  ...
  const updateTaskStatus = async (
    ...
    try {
      const response = await api.patch(
        `${API_URL}/api/v1/tasks/${taskId}/applications/${applicationId}/review`,
        { reviewStatus: status }
      );
        ...
        <div className="w-full flex items-center justify-between">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-gray-400">
              List of tasks that are yet to be completed by task doers
            </p>
          </div>
                  ...
                  <td className="px-4 py-2 text-right relative">
                    ...
                    {isOpen && (
                      <div className="absolute whitespace-nowrap right-0 bottom-10 bg-white border shadow-lg rounded-xl z-50 p-4 w-56">
                        <div className="flex flex-col gap-4">
                          <button
                            onClick={() => updateTaskStatus(task._id, task.taskId._id, "Rejected")}
                          ...
                          <button 
                            onClick={() => updateTaskStatus(task._id, task.taskId._id, "Approved")}
